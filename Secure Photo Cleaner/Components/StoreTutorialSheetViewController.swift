...
final class StoreTutorialSheetViewController: UIViewController {
    ...
    private func setupInitialAlbums() {
        albums = [
            AlbumItem(title: "Recents", sfSymbol: "clock.fill", tint: .systemGray3, showBadge: false),
            AlbumItem(title: "Screenshots", sfSymbol: "camera.viewfinder", tint: .systemGray3, showBadge: false),
            AlbumItem(title: "Videos", sfSymbol: "video.fill", tint: .systemGray3, showBadge: false),
            AlbumItem(title: "Favorites", sfSymbol: "heart.fill", tint: .systemGray3, showBadge: true),

            AlbumItem(title: "Selfies", sfSymbol: "person.crop.square", tint: .systemGray3, showBadge: false)
        ]
    }
