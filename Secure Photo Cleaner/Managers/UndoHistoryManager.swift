...
private let logger = Logger(subsystem: "com.securephotocleaner", category: "UndoHistory")

final class UndoHistoryManager {
    static let shared = UndoHistoryManager()

    private let queue = DispatchQueue(label: "com.securephotocleaner.undohistory", attributes: .concurrent)
